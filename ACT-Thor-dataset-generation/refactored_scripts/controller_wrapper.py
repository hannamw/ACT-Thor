...
class ControllerWrapper:
    ...
    def toggle_off(self, objid=None):
        objid = objid if objid is not None else self.objid
        event = self.controller.step(
    ...
    def get_bounding_box(self, objid):
        bounding_box_dict = self.controller.last_event.instance_detections2D
