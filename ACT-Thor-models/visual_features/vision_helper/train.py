...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--dataset-path", default="/datasets01/COCO/022719/", type=str, help="dataset path")
    ...
    parser.add_argument(
        "-j", "--workers", default=4, type=int, metavar="N", help="number of dataset loading workers (default: 4)"
    )
    parser.add_argument(
        "--lr",
        default=0.02,
    ...
    parser.add_argument(
        "--dataset-augmentation", default="hflip", type=str, help="dataset augmentation policy (default: hflip)"
    )
    parser.add_argument(
        "--sync-bn",
        dest="sync_bn",
